...
<div class="container">
    ...
    <div class="top-buttons">
        <form action="<%= backUrl %>" method="get">
            <button class="btn-tests" type="submit">&larr; Назад</button>
        </form>
    ...
    <table>
        ...
        <c:forEach var="test" items="${tests}">
            <tr>
                ...
                <td>${test.topic}</td>
                <td>
                    <form style="display:inline;" action="${pageContext.request.contextPath}/secure/admin/testManage" method="post">
                        <input type="hidden" name="_method" value="delete">
                        <input type="hidden" name="testId" value="${test.id}">
                        <button class="btn-delete" type="submit">Удалить</button>
                    </form>
                    <form style="display:inline;" action="${pageContext.request.contextPath}/secure/admin/testEdit" method="get">
